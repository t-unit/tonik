  ...
  group('getUser', () {
    group('request encoding', () {
      test('request path is /user', () async {
        ...
        expect(recordedRequest.uri.toString(), '$baseUrl/user');
      });
  ...
  group('patchUser', () {
    ...
    group('request encoding - body', () {
      ...
      test('encodes settings.language as string', () async {
        ...
        final response = await api.patchUser(
          meSess: 'test_session',
          body: const UserPatch(settings: UserSettings()),
        );
      ...
      test('encodes settings.blockAbusiveIPs as boolean', () async {
        ...
        final response = await api.patchUser(
          meSess: 'test_session',
          body: const UserPatch(settings: UserSettings(blockAbusiveIPs: true)),
        );
  ...
  group('getUserUsage', () {
    group('request encoding', () {
      test('request path is /user/usage', () async {
        ...
        requireSuccess(response);
        final recordedRequest = await imposterServer.takeRequest();
        expect(recordedRequest.uri.toString(), '$baseUrl/user/usage');
      });
