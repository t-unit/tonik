  ...
  group('getWebsites', () {
    group('request encoding - path and method', () {
      test('request path is /websites', () async {
        ...
        expect(recordedRequest.uri.path, '/websites');
      });
  ...
  group('postWebsites', () {
    group('request encoding - path and method', () {
      test('request path is /websites', () async {
        ...
        requireSuccess(response);
        final recordedRequest = await imposterServer.takeRequest();
        expect(recordedRequest.uri.toString(), '$baseUrl/websites');
      });
  ...
  group('getWebsitesId', () {
    group('request encoding - path and method', () {
      test('request path includes hostname parameter', () async {
        ...
        requireSuccess(response);
        final recordedRequest = await imposterServer.takeRequest();
        expect(recordedRequest.uri.toString(), '$baseUrl/websites/example.com');
      });
