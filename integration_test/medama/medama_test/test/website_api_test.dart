  ...
  group('getWebsites', () {
    group('request encoding - path and method', () {
      test('request path is /websites', () async {
        ...
        final success =
            response as TonikSuccess<GetWebsitesResponse, Response<Object?>>;
        expect(
    ...
    group('response decoding - 200', () {
      test('200 response is decoded as GetWebsitesResponse200', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<GetWebsitesResponse, Response<Object?>>>(),
        );
        final success =
            response as TonikSuccess<GetWebsitesResponse, Response<Object?>>;
  ...
  group('postWebsites', () {
    group('request encoding - path and method', () {
      test('request path is /websites', () async {
        ...
        final success =
            response as TonikSuccess<PostWebsitesResponse, Response<Object?>>;
        expect(
    ...
    group('response decoding - 201', () {
      test('201 response is decoded as PostWebsitesResponse201', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<PostWebsitesResponse, Response<Object?>>>(),
        );
        final success =
            response as TonikSuccess<PostWebsitesResponse, Response<Object?>>;
  ...
  group('getWebsitesId', () {
    group('request encoding - path and method', () {
      test('request path includes hostname parameter', () async {
        ...
        final success =
            response as TonikSuccess<GetWebsitesIdResponse, Response<Object?>>;
        expect(
          success.response.requestOptions.path,
    ...
    group('response decoding - 200', () {
      test('200 response is decoded as GetWebsitesIdResponse200', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<GetWebsitesIdResponse, Response<Object?>>>(),
        );
        final success =
            response as TonikSuccess<GetWebsitesIdResponse, Response<Object?>>;
        expect(success.response.statusCode, 200);
  ...
  group('patchWebsitesId', () {
    group('request encoding - path and method', () {
      test('request path includes hostname parameter', () async {
        ...
        final success =
            response
                as TonikSuccess<PatchWebsitesIdResponse, Response<Object?>>;
        expect(
          success.response.requestOptions.path,
          '$baseUrl/websites/example.com',
        );
    ...
    group('response decoding - 200', () {
      test('200 response is decoded as PatchWebsitesIdResponse200', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<PatchWebsitesIdResponse, Response<Object?>>>(),
        );
        final success =
            response
                as TonikSuccess<PatchWebsitesIdResponse, Response<Object?>>;
  ...
  group('deleteWebsitesId', () {
    group('request encoding - path and method', () {
      test('request path includes hostname parameter', () async {
        ...
        final success =
            response
                as TonikSuccess<DeleteWebsitesIdResponse, Response<Object?>>;
        expect(
          success.response.requestOptions.path,
          '$baseUrl/websites/example.com',
        );
    ...
    group('response decoding - 204', () {
      test('204 response is decoded as DeleteWebsitesIdResponse204', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<DeleteWebsitesIdResponse, Response<Object?>>>(),
        );
        final success =
            response
                as TonikSuccess<DeleteWebsitesIdResponse, Response<Object?>>;
