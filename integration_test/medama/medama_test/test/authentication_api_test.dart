  ...
  group('postAuthLogin', () {
    group('request encoding', () {
      test('request path is /auth/login', () async {
        ...
        final success =
            response as TonikSuccess<PostAuthLoginResponse, Response<Object?>>;
        expect(
      ...
      test(
        ...
        () async {
          ...
          final success =
              response
                  as TonikSuccess<PostAuthLoginResponse, Response<Object?>>;
          final requestBody =
              success.response.requestOptions.data as Map<String, dynamic>;
    ...
    group('response decoding - 200', () {
      test('200 response is decoded as PostAuthLoginResponse200', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<PostAuthLoginResponse, Response<Object?>>>(),
        );
        final success =
            response as TonikSuccess<PostAuthLoginResponse, Response<Object?>>;
  ...
  group('postAuthLogout', () {
    group('request encoding', () {
      test('request path is /auth/logout', () async {
        ...
        final success =
            response as TonikSuccess<PostAuthLogoutResponse, Response<Object?>>;
        expect(
          success.response.requestOptions.path,
          '$baseUrl/auth/logout',
        );
    ...
    group('response decoding - 204', () {
      test('204 response is decoded as PostAuthLogoutResponse204', () async {
        ...
        expect(
          response,
          isA<TonikSuccess<PostAuthLogoutResponse, Response<Object?>>>(),
        );
        final success =
            response as TonikSuccess<PostAuthLogoutResponse, Response<Object?>>;
