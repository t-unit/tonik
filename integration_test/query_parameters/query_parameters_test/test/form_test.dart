...
void main() {
  ...
  group('primitive', () {
    test('integer', () async {
      ...
      expect(recordedRequest.uri.query, 'integer=1');
    });
    ...
    test('double', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'double=1.0');
    });
    ...
    test('number without exponent', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'number=1.0');
    });
    ...
    test('string', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'string=test');
    });
    ...
    test('empty string sends the name with an empty value', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'string=');
    });
    ...
    test('boolean', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'boolean=true');
    });
    ...
    test('date', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'date=2000-06-15');
    });
    ...
    test('decimal', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'decimal=1.000');
    });
  });
  ...
  group('complex', () {
    test('class', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'class=name,test,age,1');
    });
    ...
    test('enum', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'enum=value1');
    });
    ...
    test('classAlias', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'classAlias=name,test,age,1');
    });
    ...
    test('anyOfPrimitive', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'anyOfPrimitive=test');
    });
    ...
    test('anyOfComplex', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'anyOfComplex=name,test,age,1');
    });
    ...
    test('oneOfPrimitive', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'oneOfPrimitive=test');
    });
    ...
    test('oneOfComplex', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'oneOfComplex=value,test,amount,1');
    });
    ...
    test('allOfPrimitive', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'allOfPrimitive=1');
    });
    ...
    test('simpleCompositeList single-encodes a reserved char in a composite '
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'simpleCompositeList=tags,a%2Cb,7');
    });
  });
  ...
  group('complex - explode true', () {
    test('class', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'name=test&age=1');
    });
    ...
    test('oneOfComplex', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'value=test&amount=1');
    });
    ...
    test('allOfComplex', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'name=test&age=1&value=test&amount=1');
    });
  });
  ...
  group('list', () {
    ...
    test('listOneOfComplexMixed - simple', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'listOneOfComplexMixed=1');
    });
    ...
    test('nullable integer encodes null element as empty', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'listNullableInteger=1,,2');
    });
  ...
  group('primitive - new types', () {
    ...
    test('integerEnum', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'integerEnum=2');
    });
    ...
    test('nullableString with value', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'nullableString=test');
    });
    ...
    test(
      ...
      () async {
        ...
        requireSuccess(response);
        final recordedRequest = await imposterServer.takeRequest();
        expect(recordedRequest.uri.query, 'nullableString=');
      },
    );
    ...
    test('nullableInteger with value', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'nullableInteger=42');
    });
  ...
  group('complex - new types', () {
    test('integerEnum', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'integerEnum=1');
    });
    ...
    test('nullableClass with value', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'nullableClass=name,test,age,25');
    });
  ...
  group('complex - explode true - new types', () {
    test('integerEnum', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'integerEnum=3');
    });
    ...
    test('nullableClass with value', () async {
      ...
      requireSuccess(response);
      final recordedRequest = await imposterServer.takeRequest();
      expect(recordedRequest.uri.query, 'name=test');
    });
