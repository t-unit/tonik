...
class HealthCheck {
  HealthCheck(this._dio);

  final _i1.Dio _dio;

  _i2.Future<_i3.TonikResult<_i4.HealthGet200BodyModel>> call({
    ...
    } on _i1.DioException catch (exception, stackTrace) {
      if (exception.type == _i1.DioExceptionType.cancel) {
        return _i3.TonikError(
          exception,
          stackTrace: stackTrace,
          type: _i3.TonikErrorType.cancelled,
    ...
    final _i4.HealthGet200BodyModel _$parsedResponse;
    try {
  ...
  _i4.HealthGet200BodyModel _parseResponse(
    _i1.Response<_i2.List<_i2.int>> response,
  ) {
    switch ((response.statusCode, response.headers.value('content-type'))) {
      case (200, r'application/json'):
        ...
        final _$body = _i4.HealthGet200BodyModel.fromJson(_$json);
        return _$body;
      default:
        final _$content =
