  ...
  group('Header Roundtrip Enum Lists', () {
    group('status enum list', () {
      test('single status enum roundtrip', () async {
        ...
        expect(recordedRequest.headers['x-status-list'], 'active');
    ...
    group('priority enum list', () {
      test('single priority enum roundtrip', () async {
        ...
        expect(recordedRequest.headers['x-priority-list'], '1');
      ...
      test('multiple priority enums roundtrip', () async {
        ...
        expect(recordedRequest.headers['x-priority-list'], '1,3,5');
      ...
      test('all priority enum values roundtrip', () async {
        ...
        expect(recordedRequest.headers['x-priority-list'], '1,2,3,4,5');
        expect(success.value.xPriorityList, [
          PriorityEnum.one,
          PriorityEnum.two,
          PriorityEnum.three,
    ...
    group('combined enum lists', () {
      test('both enum lists together roundtrip', () async {
        ...
        expect(recordedRequest.headers['x-status-list'], 'active,pending');
        expect(recordedRequest.headers['x-priority-list'], '2,4');
