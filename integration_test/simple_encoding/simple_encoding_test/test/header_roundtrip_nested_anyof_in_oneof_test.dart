  ...
  group('NestedAnyOfInOneOf header roundtrip', () {
    group('AnyOfMixed variant', () {
      test('round-trips AnyOfMixed with integer', () async {
        ...
        expect(
          result,
          isA<TonikSuccess<HeadersRoundtripNestedAnyofInOneofGet200Response, Response<Object?>>>(),
        );
        final success =
            result
                as TonikSuccess<
      ...
      test(
        ...
        () async {
          ...
          expect(
            result,
            isA<
              TonikSuccess<HeadersRoundtripNestedAnyofInOneofGet200Response, Response<Object?>>
            >(),
          );
          final success =
              result
