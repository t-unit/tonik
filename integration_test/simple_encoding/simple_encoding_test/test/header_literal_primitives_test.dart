...
void main() {
  ...
  group('primitive string header transmits literal values', () {
    for (final value in ['acme corp', '50%', '75%2Fdone', 'a%20b']) {
      test('transmits $value verbatim on the wire', () async {
        ...
        final success =
            response as TonikSuccess<HeadersRoundtripPrimitivesGet200Response, Response<Object?>>;
  ...
  group('base64 header retains standard-alphabet characters', () {
    test('bytes producing + / = survive on the wire and roundtrip', () async {
      ...
      final success =
          response as TonikSuccess<HeadersRoundtripBase64Get200Response, Response<Object?>>;
  ...
  group('control characters are rejected before dispatch', () {
    ...
    for (final entry in cases.entries) {
      test('${entry.key} in a header value is rejected pre-dispatch, '
        ...
        expect(
          control,
          isA<TonikSuccess<HeadersRoundtripPrimitivesGet200Response, Response<Object?>>>(),
        );
        ...
        expect(
          response,
          isA<TonikError<HeadersRoundtripPrimitivesGet200Response, Response<Object?>>>(),
        );
        final error =
            response as TonikError<HeadersRoundtripPrimitivesGet200Response, Response<Object?>>;
