...
class CreateItem {
  CreateItem(this._dio);

  final _i1.Dio _dio;

  _i2.Future<_i3.TonikResult<_i4.Item>> call({required _i4.Item body}) async {
    ...
    final _i4.Item _$parsedResponse;
    try {
  ...
  _i2.Object? _data({required _i4.Item body}) {
    return body.toJson();
  }
  ...
  _i4.Item _parseResponse(_i1.Response<_i2.List<_i2.int>> response) {
