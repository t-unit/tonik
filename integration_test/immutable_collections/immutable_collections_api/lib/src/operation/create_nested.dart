...
class CreateNested {
  CreateNested(this._dio);

  final _i1.Dio _dio;

  _i2.Future<_i3.TonikResult<_i4.NestedList>> call({
    required _i4.NestedList body,
  }) async {
    ...
    final _i4.NestedList _$parsedResponse;
    try {
  ...
  _i2.Object? _data({required _i4.NestedList body}) {
    return body.toJson();
  }
  ...
  _i4.NestedList _parseResponse(_i1.Response<_i2.List<_i2.int>> response) {
    switch ((response.statusCode, response.headers.value('content-type'))) {
      case (200, r'application/json'):
        ...
        final _$body = _i4.NestedList.fromJson(_$json);
        return _$body;
      default:
        final _$content =
