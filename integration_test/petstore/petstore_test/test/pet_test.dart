...
void main() {
  ...
  group('updatePet', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<UpdatePetResponse, Response<Object?>>;
  ...
  group('addPet', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<AddPetResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
  ...
  group('findPetsByStatus', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<FindPetsByStatusResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
  ...
  group('findPetsByTags', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<FindPetsByTagsResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
  ...
  group('updatePetWithForm', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<UpdatePetWithFormResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
  ...
  group('deletePet', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<DeletePetResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
  ...
  group('uploadFile', () {
    test('200', () async {
      ...
      final success = pet as TonikSuccess<UploadFileResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
  ...
  group('getPetHealth', () {
    test('200 decodes problem+json body when Content-Type carries version and '
      ...
      final success = health as TonikSuccess<GetPetHealthResponse, Response<Object?>>;
      expect(success.response.statusCode, 200);
