...
void main() {
  ...
  group('Parameter resolve propagates defaultValue', () {
    test('QueryParameterObject.resolve propagates defaultValue', () {
    ...
    test('PathParameterObject.resolve propagates defaultValue', () {
      final context = Context.initial();
    ...
    test('RequestHeaderObject.resolve propagates defaultValue', () {
      final context = Context.initial();
    ...
    test('CookieParameterObject.resolve propagates defaultValue', () {
      final context = Context.initial();
