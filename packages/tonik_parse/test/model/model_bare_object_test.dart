...
void main() {
  group('bare object classification', () {
    test('bare type: object with omitted additionalProperties imports as an '
        'Any-valued map', () {
    ...
    test('bare type: object with empty properties map imports as an '
        'Any-valued map', () {
      final spec = specWithSchemas({
    ...
    test('bare type: object imports as an Any-valued map in OpenAPI 3.1', () {
      final spec = specWithSchemas({
        'Freeform': {'type': 'object'},
      }, version: '3.1.0');
    ...
    test('object with declared properties and omitted additionalProperties '
        'stays a class', () {
      final spec = specWithSchemas({
        'Closed': {
          'type': 'object',
    ...
    test('pure object with additionalProperties true imports as an '
        'Any-valued map', () {
      final spec = specWithSchemas({
    ...
    test('pure object with empty-schema additionalProperties imports as an '
        'Any-valued map', () {
      final spec = specWithSchemas({
        'Open': {'type': 'object', 'additionalProperties': <String, dynamic>{}},
      });
