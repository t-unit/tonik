...
void main() {
  ...
  group('bare ref alias identity in allOf', () {
    ...
    const specWithRefBeforeDeclaration = {
      ...
      'components': {
        'schemas': {
          ...
          'Base': {r'$ref': '#/components/schemas/Compact'},
    ...
    test('allOf member and top-level model are the identical object '
    ...
    test('bare ref alias is present in models set even when first resolved '
    ...
    test('x-dart-name override is applied correctly when model was first '
