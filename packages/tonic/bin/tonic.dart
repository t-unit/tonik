...
void printUsage(ArgParser argParser) {
  print('Usage: dart tonic.dart <flags> [arguments]');
  print(argParser.usage);
}

final Logger logger = Logger('tonic');
