...
void main() {
  ...
  test('Imports allOf with inline schema', () {
    ...
    final inlineAllOf = api.models
        .firstWhere((m) => m is NamedModel && m.name == 'InlineAllOf');
  ...
  test('Imports allOf with reference', () {
    ...
    final referenceAllOf = api.models
        .firstWhere((m) => m is NamedModel && m.name == 'ReferenceAllOf');
