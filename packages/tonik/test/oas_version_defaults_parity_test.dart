...
void main() {
  ...
  group('OAS 3.0 / 3.1 parity — default keyword and nullability syntax', () {
    ...
    test('3.0 (nullable: true) and 3.1 (type: [.., null]) emit identical Dart '
        'for the same conceptual schema with defaults', () {
      expect(out30, contains("static const _i3.String nameDefault = r'anon';"));
      expect(out30, contains('static const _i3.int countDefault = 0;'));
      expect(out30, contains('static const _i3.double rateDefault = 1.5;'));
      expect(out30, contains('static const _i3.bool activeDefault = true;'));
      expect(
        out30,
        contains("static const _i3.String? titleDefault = r'Mx.';"),
      );
      expect(out30, contains('static const _i3.List<_i3.String> tagsDefault'));
