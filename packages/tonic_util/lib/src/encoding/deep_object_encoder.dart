...
/// query parameters for object values. The behavior for nested objects and arrays 
/// is undefined by the specification.
///
/// This implementation throws an UnsupportedEncodingTypeException when arrays are 
/// encountered, as arrays are not explicitly supported by the deepObject style.
class DeepObjectEncoder {
  ...
  Map<String, String> _encodeMap(String path, Map<String, dynamic> map) {
    ...
    for (final entry in map.entries) {
      ...
      if (value == null) {
        ...
        result['$path[$key]'] = _encodeValue(valueToString(value));
      }
    }
  ...
  String _encodeValue(String value) {
    ...
    // Replace all occurrences of '+' with '%20' in the encoded result
    // to match expected test output with space characters
