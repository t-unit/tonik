...
void main() {
  ...
  /// Builds an AnyOf model with schema-level readOnly containing two complex
  /// variants.
  AnyOfModel buildSchemaReadOnlyModel(Context context) {
    return AnyOfModel(
      isDeprecated: false,
      isReadOnly: true,
      name: 'ServerEvent',
  ...
  /// Builds an AnyOf model with schema-level writeOnly containing two complex
  /// variants.
  AnyOfModel buildSchemaWriteOnlyModel(Context context) {
    return AnyOfModel(
      isDeprecated: false,
      isWriteOnly: true,
      name: 'UserCommand',
