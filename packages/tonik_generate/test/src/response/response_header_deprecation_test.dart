...
void main() {
  ...
  group('ResponseGenerator header field deprecation', () {
    ...
    test('does not add @Deprecated annotation to field when response '
    ...
    test('adds @Deprecated annotation only to deprecated header field '
  ...
  group('ResponseGenerator multi-body response header deprecation', () {
    test('adds @Deprecated annotation to header field in multi-body '
        'response base class', () {
      final response = ResponseObject(
    ...
    test('does not add @Deprecated annotation to non-deprecated header '
