...
import 'package:typescript_nestjs_api/typescript_nestjs_api.dart';
import 'package:typescript_nestjs_example/live.dart';
...
void main() {
  ...
  test('allOf combines product and audit fields in flat JSON', () async {
    final value = success(await api.details());
